 ...
 <body>
  ...
  function flag4()
  {
   ...
   @if(isset(Auth::user()->email))
    ...
    <button type="button" style="margin-left: 10px;padding: 7px 35px; "class="btn btn-success" onclick="flag4()">Flag</button>
    <a href="{{ url('q3/logout') }}"><button type="button" class="btn btn-danger" style=" margin-left: 10px; padding:7px 35px;" >Logout</button></a>
